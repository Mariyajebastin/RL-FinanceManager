...
"""
FastAPI application for the Rl Finance Environment.

This module creates an HTTP server that exposes the RlFinanceEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m rl_finance.server.app
